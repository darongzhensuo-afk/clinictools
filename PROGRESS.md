...
### 2026-05-09 (HPA 成人健檢專案里程碑)
- **新功能:** 實作「10年慢性病風險評估」工具。整合 35-70 歲國人本土風險模型 (Cox 模型) 參數，提供紅、黃、綠燈分級處置建議，並預留國健署官方「單機版 SDK」串接架構。
- **研究開發:** 整理「國健署成人健檢 2025 新制」摘要，涵蓋 30 歲起篩檢及新增尿酸檢測項目。
- **Bug Fix:** 
    - 修正「血脂自動換算」為手動按鈕觸發。
    - 修正「HPA 風險評估」之 BMI 自動計算與清空邏輯。
- **維護規範:** 於 `GEMINI.md` 強化首頁日期同步更新準則。
...
---
*整理日期：2026/05/09 | 系統版本：1.2.0 Alpha*
